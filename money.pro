...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.moneycoin
    BOOST_LIB_SUFFIX=-mt
...
# also add new translations to money.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/moneyclient*.ts)
