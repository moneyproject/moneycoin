...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::MONEY).toInt();
    ...
    fAutoRedeemMoney = settings.value("fAutoRedeemMoney", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemMoney:
            return fAutoRedeemMoney;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemMoney: return "AutoRedeemMoney";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::MONEY).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemMoney: {
            fAutoRedeemMoney = value.toBool();
            settings.setValue("fAutoRedeemMoney", fAutoRedeemMoney);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemMoney() { return fAutoRedeemMoney; }
