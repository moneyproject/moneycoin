...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "Money Started 05.12.2016";
        CTransaction txNew;
        ...
        vSeeds.push_back(CDNSSeedData("moneycoin.pw",  "seed.moneycoin.pw"));
    }
...
public:
    CMainParams() {
        ...
        genesis.nNonce   = 421062;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000f8f81e560ad4e1cfb0f86b00f7c3e95b7ac3cf244cc66a5855a666ce32f"));
        assert(genesis.hashMerkleRoot == uint256("0x9f1f9bffb1351dc44f4199baf256a70626e637147a477c3cbcfde803772c2f4a"));
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 20639;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000c7ed46d8ec4eadf386238af624757d8c2b57c7f7af48c122b86b5304c277"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x3b13833076769c83bf61dfc83b1a977f50fea081f9ebbf9cc093a86c77b6f6f7"));
